    ...
    <>
      ...
      <section className="border-t border-hairline">
        <Container className="px-5 py-10 lg:px-[72px] lg:py-14">
          <h2 className="reveal-rise max-w-[65ch] font-display text-h2 font-light text-ink">{t('values.title')}</h2>
          <ul className="reveal-rise mt-6 max-w-[65ch]">
      ...
      <section className="border-t border-hairline">
        <Container className="grid gap-6 px-5 py-10 lg:grid-cols-[280px_1fr] lg:gap-16 lg:px-[72px] lg:py-14">
          ...
          <div className="reveal-rise flex flex-col gap-4">
      ...
      <Interlude image={interludeMiami} alt={t('interludeAlt')} />
      <section className="border-t border-hairline">
        <Container className="grid gap-6 px-5 py-10 lg:grid-cols-[280px_1fr] lg:gap-16 lg:px-[72px] lg:py-14">
          <div className="reveal-rise">
